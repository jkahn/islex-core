...
Report bugs at https://github.com/jkahn/islex-core/issues.
...
https://github.com/jkahn/islex-core/issues.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_name_here/islex-core.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv islex-core
    $ cd islex-core/
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/jkahn/islex-core/pull_requests
